...
| B2 路线一 SeACo 偏置 | 对比表完整 | 三层递进：60%→40%→30%（模型偏置/双层管线） | ✅ |
| B3 路线二 Qwen3 context | 对比表完整 | 30%→25%，context 偏置确证生效 | ✅ |
| B4 热词错误率降幅 | 至少一条 ≥ 50% | **路线一双层管线 50.0% 达标**（含副作用如实标注） | ✅ |
| B5 选型建议 | 数据 + 许可证支撑 | SeACo 双层管线进 P1，详见报告 | ✅ |
