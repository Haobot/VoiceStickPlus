#pragma once
// BMI270 feature engine 配置固件（8192 字节），来自 Bosch BMI270-Sensor-API bmi270.c。
// 关机态启用 any-motion feature 所必需：加载后 IMU 可在低功耗下检测拿起并经 INT1 输出。
// 生成自 boschsensortec/BMI270-Sensor-API master 分支 bmi270_config_file[]。
#include <stdint.h>
static const uint8_t kBmi270ConfigFile[8192] = {
